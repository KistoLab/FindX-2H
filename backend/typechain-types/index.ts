...
export type { OlympiadCertificate } from "./contracts/OlympiadCertificate";
export { OlympiadCertificate__factory } from "./factories/contracts/OlympiadCertificate__factory";
