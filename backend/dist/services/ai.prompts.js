...
const ai_mappers_1 = require("./ai.mappers");
class AIPrompts {
    static buildTaskPrompt(request) {
        ...
        const validatedTopic = ai_mappers_1.AIMappers.getValidatedTopic(request.topic, request.classType);
        const topicString = ai_mappers_1.AIMappers.mapTopicToString(validatedTopic);
        const difficultyString = ai_mappers_1.AIMappers.mapDifficultyToString(request.difficulty);
        const typeString = ai_mappers_1.AIMappers.mapTaskTypeToString(request.type);
        const classString = ai_mappers_1.AIMappers.mapClassTypeToString(request.classType);
        // Get age-appropriate topic description
        const ageAppropriateTopic = ai_mappers_1.AIMappers.getAgeAppropriateTopic(validatedTopic, request.classType);
...
- Examples: "Derivative applications", "Statistical analysis problems"`;
    ...
    static getClassSpecs() {
        return {
            [generated_1.TaskClassType.Grade_1]: {
            ...
            [generated_1.TaskClassType.Grade_2]: {
            ...
            [generated_1.TaskClassType.Grade_3]: {
            ...
            [generated_1.TaskClassType.Grade_4]: {
            ...
            [generated_1.TaskClassType.Grade_7]: {
            ...
            [generated_1.TaskClassType.Grade_8]: {
            ...
            [generated_1.TaskClassType.Grade_9]: {
            ...
            [generated_1.TaskClassType.Grade_10]: {
