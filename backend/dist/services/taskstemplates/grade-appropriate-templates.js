...
exports.getGradeAppropriateTemplate = exports.gradeAppropriateTemplates = void 0;
const generated_1 = require("@/types/generated");
// Simple grade-appropriate templates for allowed topics only
exports.gradeAppropriateTemplates = {
...
const getGradeAppropriateTemplate = (topic, difficulty, classType) => {
    ...
    const templates = exports.gradeAppropriateTemplates[gradeRange]?.[topic];
    if (!templates || !templates[difficulty]) {
        // Fallback to easy templates for the grade range and topic
        const fallbackTemplates = templates?.EASY || exports.gradeAppropriateTemplates['GRADE_1_3']['math']?.EASY;
...
exports.getGradeAppropriateTemplate = getGradeAppropriateTemplate;
...
//# sourceMappingURL=grade-appropriate-templates.js.map