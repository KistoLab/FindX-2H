...
const updateOlympiad = async (_, { id, input }) => {
    const updatedOlympiad = await models_1.OlympiadModel.findByIdAndUpdate(id, { $set: input }, { new: true }).populate({
        path: "classtypes",
        populate: {
            path: "questions",
            model: "Question"
...
exports.updateOlympiad = updateOlympiad;
//# sourceMappingURL=update-olympiad.js.map