...
exports.approveOlympiad = void 0;
...
const approveOlympiad = async (_, { id, input }) => {
    const updatedOlympiad = await models_1.OlympiadModel.findByIdAndUpdate(id, { $set: { scoreOfAward: input.scoreOfAward, status: "APPROVED" } }, { new: true }).populate({
        path: "classtypes",
        populate: {
            path: "questions",
            model: "Question"
    ...
    const transformedOlympiad = {
        ...
        organizer: updatedOlympiad.organizer && typeof updatedOlympiad.organizer === 'object' && 'toObject' in updatedOlympiad.organizer ? {
            ...updatedOlympiad.organizer.toObject(),
            id: updatedOlympiad.organizer._id.toString()
        } : null,
        classtypes: updatedOlympiad.classtypes.map((classType) => ({
            ...classType.toObject(),
...
exports.approveOlympiad = approveOlympiad;
//# sourceMappingURL=approve-olympiad.js.map