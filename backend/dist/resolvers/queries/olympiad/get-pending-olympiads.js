...
exports.getPendingOlympiads = void 0;
...
const getPendingOlympiads = async () => {
    const olympiads = await models_1.OlympiadModel.find({ status: "PENDING" }).populate({
        path: "classtypes",
        populate: {
            path: "questions",
            model: "Question"
...
exports.getPendingOlympiads = getPendingOlympiads;
//# sourceMappingURL=get-pending-olympiads.js.map