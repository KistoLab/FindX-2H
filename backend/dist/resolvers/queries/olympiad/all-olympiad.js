...
const allOlympiads = async () => {
    const olympiads = await models_1.OlympiadModel.find().populate({
        path: "classtypes",
        populate: {
            path: "questions",
            model: "Question"
...
exports.allOlympiads = allOlympiads;
//# sourceMappingURL=all-olympiad.js.map