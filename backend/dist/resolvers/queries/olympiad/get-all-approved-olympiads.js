...
exports.getAllApprovedOlympiads = void 0;
...
const getAllApprovedOlympiads = async () => {
    const olympiads = await models_1.OlympiadModel.find({ status: "APPROVED" }).populate({
        path: "classtypes",
        populate: {
            path: "questions",
            model: "Question"
...
exports.getAllApprovedOlympiads = getAllApprovedOlympiads;
//# sourceMappingURL=get-all-approved-olympiads.js.map