...
exports.listChallengeRoomResponses = void 0;
const graphql_1 = require("graphql");
const ChallengeRoomResponse_model_1 = require("@/models/ChallengeRoomResponse.model");
const listChallengeRoomResponses = async (_, { roomId }) => {
    try {
        ...
        throw new graphql_1.GraphQLError("Failed to get list challenge room responses");
    }
};
exports.listChallengeRoomResponses = listChallengeRoomResponses;
//# sourceMappingURL=get-listChallengeRoomResponses.js.map